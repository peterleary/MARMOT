...
format:
  html:
    ...
    # ──────────────────────────────────────────────
    # Grid sizing (optional)
    grid:
      body-width: 1600px
      sidebar-width: 250px
      margin-width: 100px
    
    include-in-header: /Users/peterleary/Desktop/FGCZ/MARMOT/inst/pipeline/fgcz_header.html
...
## 💾 Output
RDataFolder <- "~/Desktop/FGCZ/MARMOT/Data/Paper/Results_Files_2025-06-30_15.37.34/" # Use existing results (skip re-analysis)
...
viridisColour <- "mako"     # Palette: "magma", "inferno", "plasma", etc.
...
#### `r paste(dimRedMethodToUse)` of selected clusters
