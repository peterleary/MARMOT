...
```{r, label = "DR of selected clusters", fig.height=5, fig.width=5, results = 'asis', warning = F}
...
```{r, label = "DR of selected clusters 2", fig.height= 6*(ceiling(length(condLevels)/2)), fig.width=10, results = 'asis', warning = F}
