<!-- FROZEN: This Rmd is no longer maintained. The active pipeline is MARMOT_Pipeline.qmd. -->
<!-- Kept for reference only (scGate/SCpubr integration). Do not ship in package builds. -->
---
title: "{{PIPELINE_NAME}}"
author: ''
...
if (length(missing_vars) > 0) {
  stop("❌ Error: the following variables are missing from input_settings: ",
       paste(missing_vars, collapse = ", "),
       ". Please check that each variable exists and isn't commented out.")
}
```
...
suppressWarnings(suppressPackageStartupMessages(
  pacman::p_load(
    ...
    DT, flowAI, parallel, qs, ggrepel, gtools, reticulate, ggbeeswarm, matrixStats, Seurat,
...
if (is.null(RDataFolder)) {
  ...
  MARMOT::save_parquet_data(qsDir, envir = knit_env)
}
```
