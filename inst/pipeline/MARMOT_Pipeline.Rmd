...
plotUMAPNice <- function(
  ...
  if (show_cluster_labels) {
    gp <- Seurat::LabelClusters(plot = gp, id = cluster_labels, color = "black", box = TRUE)
  }
...
if (runScGate) {
  ...
  print(
    do_DimPlot(
      ...
      order = "Gated_Cells", 
      plot.axes = TRUE, 
      colors.use = catalystColsGates, 
      label.color = catalystColsGates
      ) +
      theme_bw() +
